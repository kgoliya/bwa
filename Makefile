...
LOBJS=		utils.o kthread.o kstring.o ksw.o pc_queue.o memsort.o samcheck.o bwt.o bntseq.o bwa.o bwamem.o bwamem_pair.o bwamem_extra.o malloc_wrap.o \
...
samcheck.o: samcheck.c
pc_queue.o: pc_queue.h pc_queue.c
